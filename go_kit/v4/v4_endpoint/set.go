...
func NewEndPointServer(svc v4_service.Service, log *zap.Logger, limit *rate.Limiter) Set {
...
func MakeLoginClientEndPoint(s v4_service.Service) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (response interface{}, err error) {
		req := request.(*LoginReq)
...
func MakeGetUserInfoEndPoint(s v4_service.Service) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (response interface{}, err error) {
...
func MakeGetUserInfoClientEndPoint(s v4_service.Service) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (response interface{}, err error) {
		req := request.(*UserInfoReq)
		resp, err := s.UserInfo(ctx, req.Token)
		if err != nil {
